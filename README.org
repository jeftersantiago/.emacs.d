...
*  Packages 
 |--------------------+--------------------------+--------------------|
 | Appearence         | Navigation               | Code               |
 |--------------------+--------------------------+--------------------|
 | org-mode           | evil                     | latex-preview-pane |
 | diff-hl            | dired-sidebar            | auctex             |
 | mood-line          | all-the-icons-dired-mode | auctex-latexmk     |
 | real-auto-save     | dired-open               | multi-term         |
 | default-text-scale | dired-hide-dotfiles      | counsel            |
 | rainbow-delimiters | swiper                   | auto-complete      |
 | almost-mono-themes | ace-window               | flycheck           |
 | inkpot-theme       | try                      | flymake            |
 | org-bullets        | graphviz-dot-mode        |                    |
 | elcord             | yasnippet                |                    |
 |--------------------+--------------------------+--------------------|
