...
;     (setq org-latex-caption-above nil)
   #+end_src
**** justify latex preview fragments
     Found this solution in there: https://emacs.stackexchange.com/questions/45212/org-mode-storing-latex-preview-files-in-a-separate-directory
**** fragment files in one directory
     #+begin_src emacs-lisp
...
#+end_src
     Avoiding being prompted every time when opening the file.
     #+begin_src emacs-lisp
